...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'tab3',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab3_tab3-routing_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab3/tab3-routing.module */ 9818)).then(m => m.Tab3PageRoutingModule)
            },
            {
                path: 'tab4',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab4_tab4-routing_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab4/tab4-routing.module */ 5355)).then(m => m.Tab4PageRoutingModule)
            },
            {
                path: 'tab5',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_tab5_tab5-routing_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../tab5/tab5-routing.module */ 6672)).then(m => m.Tab5PageRoutingModule)
            },
            {
                path: '',
